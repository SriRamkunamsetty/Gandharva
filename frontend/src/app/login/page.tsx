...
function AuthEqualizer({ count = 9 }: { count?: number }) {
    return (
...
export default function LoginPage() {
    ...
    const handleGoogleLogin = () => {
        // Future: redirect to backend OAuth endpoint
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center gap-2 cursor-pointer group">
                                <div
                                    ...
                                    style={{
                                        background: remember ? "var(--gradient-neon)" : "hsl(var(--muted))",
                                        boxShadow: remember ? "0 0 12px hsl(var(--neon-purple) / 0.4)" : "none",
                                    }}
                                >
                                    <motion.div
                                        className="absolute top-0.5 w-4 h-4 rounded-full"
                                        style={{ background: "hsl(var(--foreground))" }}
                                        animate={{ left: remember ? 22 : 2 }}
                                        transition={{ type: "spring", stiffness: 500, damping: 30 }}
                                    />
                                </div>
                                <span className="text-xs text-muted-foreground font-body">Remember me</span>
                            </label>
                            <a href="#" className="text-xs text-muted-foreground hover:text-foreground transition-colors font-body">
                                Forgot password?
                            </a>
                        </div>
                        ...
                        <button
                            ...
                            className="btn-secondary-studio w-full text-sm"
                        >
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex justify-center gap-4">
                            <motion.button
                                ...
                                className="w-12 h-12 rounded-full flex items-center justify-center text-foreground font-bold text-lg transition-all duration-300"
                                style={{
                                    background: "hsl(var(--glass-bg) / 0.8)",
                                    border: "1px solid hsl(var(--glass-border) / 0.4)",
                                }}
                                whileHover={{ scale: 1.1, boxShadow: "0 0 20px hsl(var(--neon-purple) / 0.4)" }}
                                whileTap={{ scale: 0.95 }}
                    ...
                    <div className="mt-6 text-center">
                        <Link href="/" className="text-xs text-muted-foreground hover:text-foreground transition-colors font-body">
                            ← Back to Home
                        </Link>
                    </div>
                </motion.div>
